...
define gui.text_font = "fonts/Neuton-Bold.ttf"

## El tipo de letra de los nombres de personajes
define gui.name_text_font = "fonts/Fabiana.ttf"
define gui.name_outlines = [(1, "#000000", 0, 0)]

## El tipo de letra del texto externo al juego.
define gui.interface_text_font = "fonts/Neuton-Bold.ttf"

# ¡NUEVO! Añade un contorno al texto del diálogo principal.
#define gui.text_outlines = [(2, "#000000", 0, 0)]

# ¡NUEVO! Añade un contorno al nombre del personaje.
#define gui.name_outlines = [(3, "#000000", 0, 0)]
